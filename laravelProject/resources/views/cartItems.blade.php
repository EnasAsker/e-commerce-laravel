...
<body>
  <nav class="navbar navbar-expand-sm fixed-top shadow bg-light d-flex flex-row justify-content-around">
    ...
    <ul class="navbar-nav d-flex flex-row justify-content-between">
        ...
        @if (Session::has('user')) 
        <li class="nav-item dropdown pl-4" style="color: #E55472">
      ...
      <div class="container-fluid d-flex mt-5 justify-content-around">
        ...
        <div class="card border border-0" style="width:200px"> 
         <img class="card-img-top" src="{{asset('images/'.$item->product_image)}}" alt="Card image"> 
         <div class="card-body">  
           <p class="card-text text-uppercase small">{{$item->product_name}}</p> 
         </div> 
